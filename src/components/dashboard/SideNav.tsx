...
const SideNav: React.FC = () => {
    ...
    const isAccessiblePath = useCallback(
        (path: string): boolean => {
            ...
            console.log("Matched vertical: ", matchedVertical);

            if (!matchedVertical) return true;

            console.log("Access: ", accessibleVerticals.includes(matchedVertical));
                ...
                navs: [
                    {
                        ...
                        path: `/dashboard/admin/organization/overview?id=${org.id}`,
                    },
                    {
                        name: "Members",
                        icon: (
                    ...
                    },
                    {
                        ...
                        path: `/dashboard/admin/organization/question-bank?id=${org.id}`,
                    },
                    {
                        ...
                        path: `/dashboard/admin/organization/generate-report?id=${org.id}`,
                    },
                ],
            })),
        },
    ...
    const adminLCollapsedinks: NavLink[] = [
        {
            type: "default",
            name: "Home",
            icon: (
    ...
    const adminCollapsedBottomLinks: NavLink[] = [
        {
            type: "default",
            name: "Help & Support",
            icon: (
        ...
        <>
            ...
            {!showAlternateSidebar ? (
                ...
                >
                    ...
                    <SidebarHeader
                        className={cn("py-7 bg-branding-secondary lg:py-3", {
                            "px-4": sidebarState === "expanded",
                    ...
                    >
                        <Link to="/">
                            {sidebarState === "expanded" ? (
                                <img
                                    src={lastSegment === "admin" ? logo : theme.logoUrl}
                                    alt="EngageX® Logo"
                                    className="w-8/12 max-h-10 object-contain object-left px-3 lg:px-0"
                                />
                            ) : (
                                <div className="w-8 h-8 bg-white rounded flex items-center justify-center">
                                    <span className="text-xs font-bold text-branding-secondary">eX</span>
                                </div>
                            )}
                        </Link>
                    </SidebarHeader>
                                            ...
                                            {isLoading ? (
                                                ...
                                                adminLCollapsedinks.map((link, index) => (
                                                    <Link
                                                        to={link.path!}
                                                        key={index}
                                                        className={`flex items-center justify-center w-12 h-12 rounded-full me-0 transition-colors duration-200 ${
                                ...
                                <div className="space-y-6">
                                    {adminCollapsedBottomLinks.map((link, index) => (
                                        <Link
                                            ...
                                            key={index}
                                            className={`flex items-center justify-center w-12 h-12 rounded-full me-0 transition-colors duration-200 ${
                                                location.pathname === link.path ? "bg-branding-secondary" : ""
                                            }`}
                                        >
                                            {React.isValidElement(link.icon) &&
                                                React.cloneElement(
                            ...
                            <div className="flex-1 bg-white z-20 border border-[#E4E7EC] pt-2.5 w-65">
                                ...
                                <div className="py-3.5">
                                    <div className="relative mx-auto w-[86%]">
                                        <Search
                                            className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#474D63] w-5"
                                            stroke-width={1}
                                        />
                                        <input
                                            type="text"
                                ...
                                <div className="p-4">
                                    <Link to="/dashboard/admin/organization/dashboard">
                                        <h3 className="text-gray-500 text-sm font-medium mb-3.5 tracking-wide">
                                            ALL ORGANIZATIONS
                                        </h3>{" "}
                                    </Link>
