...
const PersonalInfoForm: React.FC = () => {
    ...
    const { data: profile, isLoading, error: fetchProfileError } = useUserProfile(fullProfile?.results?.[0]?.id);
    ...
    const submit = (data: PersonalInfoFormData) => {
        ...
        if (fullProfile?.results?.[0]?.id) {
            axios
                .patch(`https://api.engagexai.io/users/userprofiles/${fullProfile?.results?.[0]?.id}/`, formData, {
                    headers: {
                    ...
                    {isUpdating || isLoading ? (
                        ...
                        <CardContent className="space-y-6 px-0 w-full lg:w-[55%]">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="space-y-2">
                                            <FormLabel className="text-[#10161E]">Email Address</FormLabel>
                                            <FormControl>
                                                <Input
                                                    type="email"
                                    ...
                                    <div className="flex-1 w-full">
                                        <div className="border border-[#EAECF0] rounded-lg p-4 sm:px-8 sm:py-4 text-center hover:bg-gray-50 transition-colors cursor-pointer">
                                            ...
                                            <label htmlFor="photo" className="cursor-pointer">
                                                ...
                                                <p className="mt-2 text-xs text-[#10161E]">
                                                    Click to upload{" "}
                                                    <span className="text-xs text-[#6F7C8E]">or drag and drop</span>
                                                </p>

                                                <p className="mt-1 text-xs text-[#6F7C8E] font-light">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className="space-y-2">
                                        <FormLabel className="text-[#10161E]">Company Name</FormLabel>
                                        <FormControl>
                                            <Input
                                                type="text"
                                                {...field}
                            ...
                            <div className="pt-4 border-t">
                                <div className="flex flex-col space-y-1">
                                    <p className="font-medium">
                                        Credits Remaining:{" "}
                                        <span className="text-green-500 ml-[2px]">{getTotalCredits()}</span>
                                    </p>
                                    <p
