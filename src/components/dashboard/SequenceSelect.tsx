...
interface SequenceSelectorProps {
  sequences: Sequence[];
  onNewSession?: (sequenceId: string) => void;
...
const SequenceSelector: React.FC<SequenceSelectorProps> = ({
  ...
  const toggleSequence = (sequenceId: string): void => {
  ...
  const handleNewSession = (sequenceId: string): void => {
              ...
              <div key={sequence?.id}>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
                    <div>
                      <p
                        className={`text-sm ${expandedSequence === sequence?.id
                          ? "text-[#0E7B33]"
                          : "text-[#6F7C8E]"
                          }`}
                      >
