    ...
    return (
        ...
        >
            ...
            <DialogContent
                ...
                className={` ${step === 4 || step === 5 || step === 1 ?  "w-[min(100%,25rem)]" : "w-[85vw] md:max-w-[50vw]"}  my-auto mx-auto  max-md:mt-5 max-md:max-h-[90vh] [&>button]:hidden`}
            ...
            >
                <div className="max-h-fit">
                    ...
                    {step === 3 && (
                        <StepThree filePreview={agreementState.filePreview} handleFileChange={handleFileChange} />
                    )}
                    {step === 4 && (
                        <StepFour
                            ...
                            setIndustryType={(value) =>
                                setAgreementState((prevState) => ({ ...prevState, industryType: value }))
                            }
                        />
                    )}
                    {step === 5 && (
                    ...
                    {step < 5 ? (
                        <Button
                            ...
                            disabled={
                                ...
                                (step === 4 && ( agreementState.industryState === "" || agreementState.industryType === ""))
                            }
                        >
    ...
    return (
        <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex gap-2 mx-auto justify-center w-full items-center">
                <p className="sm:text-2xl text-3xl text-nowrap font-[Neue Montreal]">Welcome to</p>
                <img src={engageXModalLogo} className="h-[1.7rem] sm:h-[1.7rem] mt-[0.45rem] lg:mt-[0.3rem] w-auto" alt="" />
            </div>
                ...
                <div>
                    <div className="font-[montserrat]">
                        ...
                        <ul className="list-disc leading-7">
                            <li>
                                <strong>Personal Information:</strong> Name, email address, and account details.
                            </li>
                            <li>
                                <strong>Session Data:</strong> Audio analysis for AI-driven feedback (not stored beyond
                                24 hours).
                            </li>
                            <li>
                                <strong>Usage Information:</strong> Browser type, device information, and interaction
                                data for improving user experience.
                            </li>
                        </ul>
                        ...
                        <ul className="list-disc leading-7">
                            <li>EngageX™ does not permanently store your session recordings.</li>
                            <li>All session recordings are deleted after 24 hours unless downloaded.</li>
                            <li>We use encryption and security measures to protect your data.</li>
                        </ul>

                        <p className="my-4">5. Sharing & Third-Party Access</p>
                        <p>EngageX™ does not sell or share personal data with third parties except:</p>
                        <ul className="list-disc leading-7">
                        ...
                        <ul className="list-disc leading-7">
                            <li>
                                <strong>Access & Deletion:</strong> You can request access to your stored personal data
                                or its deletion.
                            </li>
                            <li>
                                <strong>Session Recordings:</strong> Once downloaded, EngageX™ is not responsible for
...
function StepFour({
    ...
    return (
        <div className="flex flex-col gap-1">
            ...
            <p className="mx-auto font-medium font-[montserrat] text-base">Select Industry</p>
            ...
            <div className="relative w-full my-5">
                ...
                className="font-normal py-2 my-2 w-full font-[Inter]" id="industry type">
                    <option className="text-gray-300" value="">Choose industry type</option>
                    ...
                    <option value="technology_software_development">Technology & Software Development</option>
    ...
    return (
        <div className="flex flex-col font-medium font-[montserrat] items-center overflow-hidden gap-1">
           <div className="flex gap-2 mx-auto justify-center w-full items-center">
            ...
            <p className="text-center leading-7 my-2">You’ve finally completed the user level agreement, you can now proceed to the dashboard homepage</p>
        </div>
    );
}