  ...
  return (
    <header className="flex h-16 shrink-0 items-center justify-between gap-2 px-10 mx-4 md:border-b-1 border-bright-gray">
      ...
      <div className="left__top__nav hidden lg:flex items-center">
        ...
        <BellIcon className="text-[#252A39] w-5" />

        <div className="line h-7 mx-4 w-[1px] bg-[#98A2B3]"></div>
        <div className="user__image">
          <div
            className={`size-8 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0 ${!profile?.profile_picture && "border border-[#D0D5DD] bg-[#D0D5DD]"}`}
          >
