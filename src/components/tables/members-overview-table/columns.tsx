...
export const columns: ColumnDef<Member, any>[] = [
    {
        accessorKey: "member",
        header: () => <div className="flex items-center gap-[8px] text-[#252A39] py-4 cursor-pointer">Member</div>,
        cell: ({ row }) => {
    ...
    {
        accessorKey: "role",
        header: () => <div className="flex items-center gap-[8px] text-[#252A39] py-4 cursor-pointer">Role</div>,
        cell: ({ row }) => <div className="mb-auto text-gray-700">{row.getValue("role")}</div>,
    },
    {
        accessorKey: "lastLogin",
        header: () => <div className="flex items-center gap-[8px] text-[#252A39] py-4 cursor-pointer">Last Login</div>,
        cell: ({ row }) => <div className="text-gray-700">{row.getValue("lastLogin")}</div>,
    },
    {
        accessorKey: "creditsUsed",
        header: () => (
            <div className="flex items-center gap-[8px] text-[#252A39] py-4 cursor-pointer">Credits used</div>
        ),
        cell: ({ row }) => <div className="text-gray-700 font-medium">{row.getValue("creditsUsed")}</div>,
    },
    {
        accessorKey: "action",
        header: () => (
