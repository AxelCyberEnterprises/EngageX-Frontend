...
import { UploadExcelSchema } from "@/schemas/dashboard/admin";
...
type FormType = z.infer<typeof UploadExcelSchema>;
...
const UploadExcelForm = () => {
  ...
  useEffect(() => {
    if (form.getValues("excel")) {
      setFileIsSelected(true);
    } else {
      setFileIsSelected(false);
    }
  }, [form.watch("excel")]); // ✅ watch field properly
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)}>
        ...
        >
          <FileSpreadsheet className="h-12 w-10 text-[#B9BCC8]" />

          <div className="space-y-2 text-center text-primary-blue">
            <h6 className="text-2xl font-normal">Upload Excel File</h6>
