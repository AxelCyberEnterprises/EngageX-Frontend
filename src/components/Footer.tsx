...
function Footer() {
    ...
    const getActiveClass = (path: string) => (location.pathname === path ? "text-[#64BA9F]" : "text-white");
              ...
              >
                ...
                <div className="flex flex-col lg:flex-row space-y-16 font-montserrat lg:w-3/4 justify-between lg:pl-[10rem]">
                    ...
                    <div className="space-y-8">
                        ...
                        <ul className="space-y-6">
                            <li>
                                <Link to="/contact#faq" className={getActiveClass("/contact#faq")}>
                                    FAQ
                                </Link>
                            </li>
                            <li>
                    ...
                    <div className="space-y-8">
                        ...
                        <ul className="space-y-6">
                            <li>
                                <Link to="/privacy-policy" className={getActiveClass("/privacy-policy")}>
                                    Privacy policy
                                </Link>
                            </li>
                            <li>
                                <Link to="/terms-of-service" className={getActiveClass("/terms-of-service")}>
                                    Terms of service
                                </Link>
                            </li>
                            <li>
                                <Link
                                    ...
                                    className={getActiveClass("/security-and-compliance")}
                                >
                                    Security & Compliance
                                </Link>
                            </li>
