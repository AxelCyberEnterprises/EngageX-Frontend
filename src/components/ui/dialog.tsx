...
// Context to detect if onOpenChange is provided
const DialogContext = React.createContext<{ hasOnOpenChange: boolean }>({ hasOnOpenChange: false });

function Dialog({ onOpenChange, ...props }: React.ComponentProps<typeof DialogPrimitive.Root>) {
    return (
        <DialogContext.Provider value={{ hasOnOpenChange: typeof onOpenChange === "function" }}>
