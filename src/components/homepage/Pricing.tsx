              ...
              <div className="h-full lg:w-[50%]">
                  <div className="lg:w-full pr-[30px] lg:pr-0">
                      ...
                      <p className="mt-4 font-montserrat">
                          For organizations with more than 10 individuals, we offer a customized enterprise plan
                          designed for seamless multi-user access
                      </p>
                      <ul className="space-y-4 mt-6">
                          <li className="list-disc">Enterprise volume pricing discount</li>
                          <li className="list-disc">Internal report sharing </li>
                          <li className="list-disc">White labelling with logo and brand colors</li>
