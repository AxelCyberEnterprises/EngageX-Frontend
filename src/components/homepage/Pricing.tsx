...
function Pricing({ subtext, showPricing }: { subtext?: string; showPricing?: boolean }) {
    let plans = [
        {
            type: "STARTER PLAN",
            price: 180,
        ...
        <section className=" px-10 lg:px-20 py-28 font-montserrat gap-y-24 relative flex flex-col justify-center items-center">
            <div className="space-y-10 flex flex-col items-center">
                <div className="px-3 py-3 flex gap-2 items-center w-max border rounded-lg bg-white border-[#E1E5E7] mx-auto">
                    ...
                    <p className="small">ENTERPRISE SOLUTIONS</p>
                </div>
                ...
                <div className="h-full lg:w-[50%]">
                    <div className="lg:w-full pr-[30px] lg:pr-0">
                        ...
                        <p className="mt-4 font-montserrat">
                            Experience white glove treatment with a dedicated administrator for organizations with more
                            than 10 individuals. We can offer customized solutions for seamless multi-user access:
                        </p>
                        <ul className="space-y-4 mt-6">
                            <li className="list-disc">Enterprise volume discounting</li>
                            <li className="list-disc">White labeling for logo and brand colors</li>
                            <li className="list-disc">CSV/Excel bulk user admin onboarding</li>
                            <li className="list-disc">Targeted goal reporting</li>
                            <li className="list-disc">SSO user sign on</li>
                            <li className="list-disc">Customized question & objection banks</li>
                        </ul>
                        <a
                            href="https://calendly.com/jacqui-thecareerdoctor/engagex-live-speech-coaching-clone"
                            target="_blank"
                        >
