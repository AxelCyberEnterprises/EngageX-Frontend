                ...
                <div className="h-full lg:w-[50%]">
                    <div className="lg:w-full pr-[30px] lg:pr-0">
                        ...
                        <p className="mt-4 font-montserrat">
                            If you need a custom solution for your organization, corporate training, or coaching
                            program? We offer tailored enterprise plans with multi-user access, team analytics, and
                            coaching support.
                        </p>
