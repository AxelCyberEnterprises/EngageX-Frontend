...
import RedHillsLogo from "@/assets/images/pngs/Red_Hills_Consulting_Group.png";
...
function SocialProof() {
    const quotes = [
        ...
        {
            text: "\u201CEngageX\u00AE gave me a realistic, low-stakes environment to practice and refine my public speaking before a major national conference -- the recorded sessions and detailed feedback reports were invaluable in helping me show up with confidence and clarity.\u201D",
            name: "Renée Jones",
            title: "Founder & CEO, Red Hills Consulting Group",
        },
    ];
    ...
    const partners = [
        ...
        { src: RedHillsLogo, alt: "Red Hills Consulting Group" },
    ];
    ...
    return (
        <section className="bg-alice-blue px-10 lg:px-20 py-16">
            ...
            <div className="text-center mb-12">
                <h5 className="font-montreal font-semibold text-gunmetal">Real people. Real results.</h5>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
                {quotes.map((quote, idx) => (
                    <div
                        key={idx}
                        className="flex-shrink-0 w-full md:h-[28rem] h-auto flex flex-col justify-between py-10 items-center relative md:overflow-clip overflow-visible border bg-white"
                    >
                        ...
                        <p className="text-base text-center px-4 text-pretty relative z-10">{quote.text}</p>
            ...
            <div className="mt-20 text-center">
                <p className="text-xs text-gunmetal/40 uppercase tracking-[0.2em] mb-10 font-medium">
