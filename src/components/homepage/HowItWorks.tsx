        ...
        <section className="bg-alice-blue px-10 lg:px-20 py-28 gap-y-24 flex flex-col justify-center items-center">
            <div className="space-y-[24px] flex flex-col items-center">
                ...
                <div className="text-center mx-auto space-y-4 flex flex-col items-center">
                    ...
                    <p className="text-dark-electric-blue leading-normal">A simple way to use EngageX™</p>
                </div>
            </div>
                ...
                <div className="lg:w-[35%]">
                    <div className="flex gap-x-8 items-center">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="small text-dark-electric-blue">
                                Create your personal profile and select your speaking focus, i.e. pitch, presentation,
                                or public speaking + storytelling
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-x-8 items-center">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="small text-dark-electric-blue">
                                If your speaking engagement involves a presentation deck, feel free to upload your
                                slides and acknowledge the confidentiality agreement/NDA
                            </p>
                        </div>
                    </div>
                    <div className=" relative h-20 z-10 w-16 flex items-center justify-center">
                    ...
                    <div className="flex gap-x-8 items-center">
                        ...
                        <div className="space-y-4">
                            <h6 className="font-montreal">Practice in a realistic virtual room</h6>
                            <p className="small text-dark-electric-blue">
                                Begin your engagement with dynamic audience simulations and AI-powered audience feedback
                            </p>
                        </div>
                    </div>
                    <div className=" relative h-20 z-10 w-16 flex items-center justify-center">
                    ...
                    <div className="flex gap-x-8 items-center">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="small text-dark-electric-blue">
                                Analyze detailed video feedback and download key moments to re-watch and refine your
                                skills
                            </p>
                        </div>
                    </div>
