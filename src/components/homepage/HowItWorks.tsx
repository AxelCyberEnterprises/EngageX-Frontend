  ...
  const steps = [
    {
      ...
      description:
        "Storytelling, presentation, pitch, or practice with coaching questions.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Step into a realistic virtual room with AI-powered avatar audiences.",
    },
    {
      icon: (
        <svg
      ...
      description:
        "Receive AI precision + human coach insight to know exactly what to fix.",
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {steps.map((step, idx) => (
            ...
            >
              ...
              <p className="text-dark-electric-blue leading-relaxed">
                {step.description}
              </p>
            </div>
          ))}
