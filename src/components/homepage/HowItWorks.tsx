    ...
    const steps = [
        {
            ...
            description: "Storytelling, presentation, pitch, or practice with coaching questions.",
        },
        {
            icon: (
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M15 10L19.553 7.724C19.7054 7.64784 19.8748 7.61188 20.045 7.61953C20.2152 7.62718 20.3806 7.67818 20.5256 7.76782C20.6706 7.85746 20.7902 7.98278 20.8733 8.13184C20.9563 8.2809 20.9999 8.44876 21 8.619V15.381C20.9999 15.5512 20.9563 15.7191 20.8733 15.8682C20.7902 16.0172 20.6706 16.1425 20.5256 16.2322C20.3806 16.3218 20.2152 16.3728 20.045 16.3805C19.8748 16.3881 19.7054 16.3522 19.553 16.276L15 14M5 18H13C14.1046 18 15 17.1046 15 16V8C15 6.89543 14.1046 6 13 6H5C3.89543 6 3 6.89543 3 8V16C3 17.1046 3.89543 18 5 18Z"
                        stroke="white"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
            ...
            description: "Step into a realistic virtual room with AI-powered avatar audiences.",
        },
        {
            icon: (
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            description: "Receive AI precision + human coach insight to know exactly what to fix.",
        },
    ];

    return (
        <section className="bg-white px-10 lg:px-20 py-28">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="text-center mb-16 space-y-4">
                    ...
                    <h4 className="h-max font-montreal leading-snug">It's simpler than you think.</h4>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    {steps.map((step, idx) => (
                        <div key={idx} className="flex flex-col items-center text-center space-y-4">
                            <div className="w-16 h-16 rounded-full bg-gunmetal flex items-center justify-center">
                                {step.icon}
                            </div>
                            <h6 className="font-montreal font-semibold text-lg">{step.title}</h6>
                            <p className="text-dark-electric-blue leading-relaxed">{step.description}</p>
                        </div>
                    ))}
                </div>

                {/* CTA */}
                <div className="flex justify-center mt-14 gap-4 flex-wrap">
                    <Link to="/auth/signup">
                        <button className="flex gap-2 py-4 px-8 items-center justify-center rounded-lg bg-[#64BA9F] text-white font-semibold">
                    ...
                    <Link to="https://youtu.be/9wngYuqKK7Q?si=dyYU2qiEH9TXYM2R" target="_blank">
                        <button className="flex gap-2 py-4 px-8 items-center justify-center rounded-lg bg-[#EDEDED] hover:bg-[#D4D4D4] text-[#253141] font-semibold">
                            <p>
                                {" "}
