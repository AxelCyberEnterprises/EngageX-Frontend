        ...
        <section className="px-10">
            ...
            <div className="space-y-8">
                <div className="hidden lg:block w-full overflow-clip h-[30rem] relative">
                    <img src="/assets/presshero.png" className=" h-full w-full absolute object-cover top-0" />
                </div>
                ...
                <div className="space-y-6 py-6">
                    ...
                    <p className="text-[#667085] font-montserrat">
                        ...
                        and optimize existing, high performance AI foundations with innovative new structure/design.
                        This approach dramatically reduces our carbon footprint while unlocking powerful features like
                        real-time engagement analysis, intelligent speech coaching, and instant feedback generation.
                    </p>
                    <p className="text-[#667085] font-montserrat">
                    ...
                    <ul className="text-[#667085] font-montserrat space-y-2 pl-6">
                        ...
                        <li className="list-disc">
                            We deploy lightweight, cloud optimized systems, minimizing energy use without sacrificing
                            speed or accuracy.
                        </li>
                        <li className="list-disc">
                            We reduce environmental waste by skipping redundant training cycles and using infrastructure
