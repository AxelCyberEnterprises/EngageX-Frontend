    ...
    const posts = [
        {
            ...
            download: true,
            summary:
                "Join the creatives and web managers of Career Doctor, LLC as they discuss how they navigate all three platforms and market EngageX along with with entire CDC, LLC brand.",
        },
        {
