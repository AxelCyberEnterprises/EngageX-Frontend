                ...
                <div className="flex-1 relative z-20 space-y-2 px-10 text-center lg:text-left">
                    ...
                    <div className="space-y-8">
                        <h2 className="font-montreal leading-snug">
                            Transform your speaking skills with EngageX<sup>®</sup>
                        </h2>
                        <p className="big text-[#62717A]">
                            Step into the future of public speaking, persuasive storytelling, pitching, and
                            presentations with EngageX<sup>®</sup>, a training platform designed to enhance your
                            confidence, delivery, and audience engagement using cutting edge technology combined with AI
                            and award-winning coaches.
                        </p>
                    </div>
