    ...
    return (
        ...
        >
            ...
            {item.img ? (
                ...
                <Carousel className="w-full max-w-sm mt-22 lg:mt-0 lg:mr-22">
                    <CarouselContent>
                        {item.carousel?.map((carouselItem, index) => (
                            <CarouselItem key={index}>
                                <div className="p-1">
                                    <Card className="border-0">
                                        <CardContent className="flex flex-col items-center justify-center p-6 text-center">
                                            <h5 className="text-lg font-medium">{carouselItem.title}</h5>
                                            <p className="text-sm text-gray-600">{carouselItem.content}</p>
                                        </CardContent>
                                    </Card>
                                </div>
                            </CarouselItem>
