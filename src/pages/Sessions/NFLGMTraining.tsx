...
const NFLMediaTraining: React.FC = () => {
    ...
    const [videoUrl, setVideoUrl] = useState(
        "https://engagex-user-content-1234.s3.us-west-1.amazonaws.com/static-videos/Rookie+Room/NFL/NFL+GM+No+sound.mp4",
    );
    ...
    const [questionImg] = useState<string>(
        "https://engagex-user-content-1234.s3.us-west-1.amazonaws.com/static-videos/Rookie+Room/NFL/NFL+GM+Facecard.png",
    );
    ...
    useEffect(() => {
        if (sessionQuestions && Array.isArray((sessionQuestions as any).results)) {
            ...
            if (Array.isArray(results) && enterprise_id) {
                ...
                questionsRef.current = pickSessionQuestions(results, enterprise_id, "gm_nfl", 8, id);
            } else {
