...
const MLBMediaTraining: React.FC = () => {
    ...
    const [videoUrl, setVideoUrl] = useState(
        "https://engagex-user-content-1234.s3.us-west-1.amazonaws.com/static-videos/Rookie+Room/MLB/MLB+GM+No+sound.mp4",
    );
    ...
    const [questionImg] = useState<string>(
        "https://engagex-user-content-1234.s3.us-west-1.amazonaws.com/static-videos/Rookie+Room/MLB/MLB+GM+Facecard.jpeg",
    );
    ...
    const { data: sessionQuestions, isPending: getQuestionsPending } = useGetSessionQuestions(enterprise_id ?? 0, "gm");
    ...
    useEffect(() => {
        if (sessionQuestions && Array.isArray((sessionQuestions as any).results)) {
            ...
            if (Array.isArray(results) && enterprise_id) {
                ...
                const picked = pickSessionQuestions(results, enterprise_id, "gm_mlb", 8, id);
                setQuestions(picked);
    ...
    useEffect(() => {
        ...
        ws.onmessage = (event) => {
            try {
                ...
                if (parsed.type === "full_analysis_update") {
                    console.log(parsed);
        ...
        <div className="text-primary-blue">
            ...
            >
                <DialogContent hideCloseButton={true} className="flex flex-col gap-4">
                    ...
                    <img
                        src={questionImg}
                        alt="MLB GM giving a presentation"
...
export default MLBMediaTraining;