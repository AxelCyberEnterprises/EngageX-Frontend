...
const UserDashboardHome: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const goalsAt100 = Object.values(goalsData).filter((value) => value === 100)
      .length;
  ...
  const userIdAfterSignup = useSelector(
    (state: RootState) => state.auth.userIdAfterSignup
  );
        ...
        <div className="w-full lg:w-6/9 lg:pe-2 mb-3">
          ...
          <div className="analytics px-5 py-7 mt-6 mb-4 rounded-[8px]">
            ...
            <p className="text-sm text-muted-foreground mt-6">
              ...
              audience’s engagement, where a trigger evokes the audience to
              respond in some shape or form as a reaction to the
