                ...
                {activeIndex === 0 && (
                    <div>
                        <section className="flex justify-between md:items-start items-center gap-5 mb-6 sm:mt-0 mt-4">
                            ...
                            <Button type="button" onClick={() => {}} className="w-auto text-white px-6 bg-[#252A39]">
                                <img src={menuWhite} alt="Plus Circle" className="w-5 h-5 sm:text-base text-sm" />
                                View all goals
                            </Button>
                        </section>
                            ...
                            <div className="gap-0 px-4 py-2 rounded-[12px] border border-[#E0E0E0] shadow-[0px_2px_8px_0px_#252A3914]">
                                ...
                                {achievementData.slice(0, 3).map((item) => (
                                    <div className="flex gap-3 mb-6 px-2">
                                        <div
                                            className={`flex flex-col items-center justify-between p-2 rounded-[6px] ${item.level === 1 && "bg-[#64BA9F]"}  ${item.level === 2 && "bg-[#ECB25E]"}  ${item.level === 3 && "bg-[#C1C2B4]"} ${item.level === 4 && "bg-[#C29C81]"} ${item.level === 5 && "bg-[#253141]"} ${item.level === 6 && "bg-[#64BA9F]"}`}
                                        >
                                            ...
                                            <p className="text-white md:text-xs text-[11px] whitespace-nowrap">
                                                LEVEL {item.level}
                                            </p>
                                        </div>
                        ...
                        <section className="flex items-center justify-between sm:mt-18 mt-12">
                            <div>
                                ...
                                <p className="lg:text-lg text-base text-[#6F7C8E] mb-6">
                                    Track your speaking progress across multiples sessions
                                </p>
                            </div>
                            <Button
                                type="button"
                        ...
                        <section className="flex md:flex-row flex-col-reverse md:items-center justify-between md:mt-10 mt-4 md:mb-6 mb-3 gap-6">
                            ...
                            <div>
                                <ShadSelect
                                    ...
                                    icon={calendar}
                                />
                                <p className="text-[#6F7C8E] sm:text-sm text-xs mt-1">
                                    Choose improvement sequence to get full info.
                                </p>
                            </div>
                        </section>
                        <section>
                        ...
                        <section className="mt-16 mb-6 border border-[#E0E0E0] sm:p-6 p-4 bg-white rounded-[16px]">
                            ...
                            <PresentationMetricsTable columns={columns} data={data} pageSize={7} />
                        </section>
                    </div>
                )}
                            ...
                            <div className="pl-6 pt-4 rounded-lg border border-gray-200 bg-white shadow-none">
                                <div className="flex justify-between gap-4 items-center mb-6 mr-6 overflow-auto scrollbar-hide">
                                    ...
                                    <div className="flex gap-2 items-center">
                                        ...
                                        <p className="text-sm underline cursor-pointer whitespace-nowrap">View All</p>
                                    </div>
                                </div>
