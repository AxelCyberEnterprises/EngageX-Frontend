            ...
            <div className="h-screen flex flex-col sm:pt-8 pt-6 sm:px-8 px-4">
                <div className="bg-white z-10 sticky top-0 flex justify-between items-center mb-4">
                    ...
                    <div className="flex gap-5">
                        ...
                        <SidebarTrigger className="-ml-1 p-5 bg-branding-secondary hover:bg-branding-secondary/90 hover:text-white" />
                    </div>
                </div>
                    ...
                    <div className="relative flex gap-4 min-w-max border-b-2 border-[#E0E0E0]">
                        {sectionItems.map((item, index) => (
                            ...
                            >
                                ...
                                {activeIndex === index && (
                                    <span className="absolute -bottom-[2px] left-0 w-full h-[2px] bg-branding-secondary transition-colors duration-700"></span>
                                )}
                            </div>
                        ))}
                    </div>
