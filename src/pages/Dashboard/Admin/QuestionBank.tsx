  ...
  return (
    ...
    >
      ...
      <div className="flex-1 py-4 pr-4">
        <div className="text-[#474D63] font-normal text-sm">
          {item.question}
        </div>
      </div>
...
const QuestionBank = () => {
  ...
  const [questions, setQuestions] = useState<QuestionBankItem[]>([
    {
      id: "1",
      question: "Explain the ROI calculation for a marketing campaign with a $5,000 budget that generated $20,000 in sales.",
      order: 1,
    },
    {
      id: "2", 
