...
const Overview = () => {
    ...
    const statsMock = stats
        ? [
              ...
              { label: "1 on 1 Coaching activated", value: stats.coaching_sessions_booked },
    ...
    return (
        <div className="px-6 pb-8 bg-white min-h-screen">
            <h3 className="py-4 md:pl-6 pl-3 border-b border-[#ECEEF4] font-medium md:text-3xl text-xl">
            ...
            <div className="flex items-center justify-between py-3">
                <div className="md:flex items-center gap-3 hidden">
                    ...
                    {isLoading ? (
                        ...
                        <h1 className="text-2xl font-medium text-[#333333]">{organization?.name}</h1>
                    )}
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button
                        className="px-4 py-3 border border-[#252A39] rounded-md text-[#252A39] bg-transparent hover:bg-transparent hover:scale-105 transition-all duration-200 font-normal flex items-center gap-2"
                    ...
                    <Button
                        className="px-4 py-3 border border-[#252A39] rounded-md text-[#252A39] bg-transparent hover:bg-transparent hover:scale-105 transition-all duration-200 font-normal flex items-center gap-2"
                        onClick={() => setShowVerticalsModal(true)}
                    >
                    ...
                    >
                        <div className="bg-white border border-gray-200 md:space-y-12 space-y-6 rounded-md p-4 h-full">
                            ...
                            {loadingStats ? (
                                ...
                                <p className="lg:text-4xl md:text-3xl text-2xl font-medium text-[#18181B]">
                                    {stat.value}
                                </p>
                            )}
                        </div>
            ...
            <div>
                ...
                {isLoading ? (
                    ...
                    <MembersOverviewTable orgId={orgId} pageSize={5} hidePagination={true} />
                )}
            </div>
            ...
            <div>
                ...
                {isLoading ? (
                    ...
                    <GoalsTable orgId={orgId} pageSize={5} hidePagination={true} />
                )}
            </div>
            ...
            <IssueCreditsModal show={showCreditModal} onClose={() => setShowCreditModal(false)} orgId={orgId} />
            <AddBookingLinkModal
