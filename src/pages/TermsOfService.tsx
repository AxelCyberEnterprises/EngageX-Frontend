            ...
            <div className="space-y-20 py-36 font-montserrat px-10 lg:px-20">
                ...
                <div className="space-y-16 text-[#475467]">
                    <div className="space-y-5">
                        <p className="big">
                            EngageX<sup>®</sup> Cookie Policy
                        </p>
                        <p className="big">Effective Date: 05/20/2025</p>
                        <p className="big">
                            Welcome to EngageX<sup>®</sup>! These Terms of Service ("Terms") govern your use of our
                            AI-powered platform for public speaking, pitch, and presentation services ("Services"). By
                            accessing or using EngageX<sup>®</sup>, you agree to comply with and be bound by these
                            Terms
                        </p>
                    </div>
                    <div className="space-y-6">
                        ...
                        <p className="big">
                            By registering for, accessing, or using EngageX<sup>®</sup>, you confirm that you have
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="big space-y-6">
                            ...
                            <p className="big">
                                EngageX<sup>®</sup> reserves the right to suspend or terminate accounts found to be in
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="big space-y-6">
                            <p className="big">
                                You may use EngageX<sup>®</sup> only for lawful purposes
                            </p>
                            <p className="big">
                                You agree not to misuse, distribute, or reverse-engineer any part of the platform
                            </p>
                            <p className="big">
                                EngageX<sup>®</sup> reserves the right to modify or discontinue any aspect of the
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="big space-y-6">
                            <p className="big">
                                EngageX<sup>®</sup> and its content (including software, graphics, and AI-generated
                                insights) are protected by intellectual property laws
                            </p>
                            <p className="big">
                                You may not copy, reproduce, or distribute EngageX<sup>®</sup> content without our
                                written consent
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="big space-y-6">
                            ...
                            <p className="big">
                                EngageX<sup>®</sup> reserves the right to modify pricing at any time
                            </p>
                        </div>
                    </div>
                    <div className="space-y-6">
                        ...
                        <div className="big space-y-6">
                            <p className="big">
                                EngageX<sup>®</sup> provides its Services "as is" and does not guarantee error-free
                                performance
                            </p>
                            <p className="big">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="big space-y-6">
                            <p className="big">
                                EngageX<sup>®</sup> reserves the right to terminate your access for any breach of these
                                Terms
                            </p>
